...
CREATE TABLE `borrower` (
  ...
  `status` smallint(6) DEFAULT NULL COMMENT '状态: 0:冻结 1:启动',
  PRIMARY KEY (`id`)
...
CREATE TABLE `borrowing` (
  ...
  `status` smallint(6) DEFAULT NULL COMMENT '状态: 1.借阅中. 2已归还 3.超时借阅 4.意外丢失/损坏',
  `borrower_id` bigint(20) DEFAULT NULL COMMENT '借阅人',
  `book_id` bigint(20) DEFAULT NULL COMMENT '借阅的图书',
  PRIMARY KEY (`id`),
...
CREATE TABLE `user` (
  ...
  `status` int(11) DEFAULT NULL COMMENT '状态: 0: 启动 1: 禁用',
